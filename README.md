...
### 4. 게시글에 대한 암호 지정
- 보안 상 당연한 이야기이겠지만 보통 내가 쓴 글을 수정하거나 삭제하고 싶을 때 꼭 로그인을 해야한다는 사실이 조금 귀찮았다. 내가 쓴 글이 그렇게 많지 않을때, __검색만으로 내 글을 찾아서 바로 삭제할 수 있다면 좋지 않을까.__
